...
<script>
    ...
    $(function () {
        ...
        $('#users-table').DataTable({
            ...
            serverSide: false,
            deferLoading: 0,
            ajax: '{!! url("/import/importElec/anyData") !!}',
            columns: [
                {
                    data: null, 
        ...
        $("#tenementFlatElecSubmit").manualSubmit('frmtenementFlatElec');
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        ...
        <h2>Nhập chỉ số tiêu thụ Điện từ File</h2>
      </div>
    </div>
  </div>
</div>
...
<div class="table-responsive">
    <div class="col-lg-12">
        ...
        {{ Form::open(['route' => ['ImportElec.download'],  'method' => 'POST', 'id'=>'frmtenementFlatElec']) }}
            {!! csrf_field() !!}
            <h3>1) Tải file mẫu sau khi nhập các thông tin chung</h3>
            <table class="table table-striped table-bordered table-hover table-condensed">
                <tbody>
                    <tr class="info" style="color: black">
                        <td>Chỉ số điện cho Phiếu thu tháng<em style='color:red'>(*)</em> </td>
                        <td>
                        ...
                        <td>
                            <input class="date-picker" type="text" value="{!! old('date_from') !!}" id="date_from" name="date_from" size="10%">
                            ~
                            <input class="date-picker" type="text" value="{!! old('date_to') !!}" id="date_to" name="date_to" size="10%">
                        </td>
                        </tr>
                        <tr>
                        <td>Ghi chú</td>
                        ...
                        <td>
                            <button id='tenementFlatElecSubmit' type="button" class="btn btn-primary">Tạo File Mẫu</button>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="col-lg-12">
            ...
            <form style="margin-top: 15px;" action="{{ URL::to('import/importElec/store') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                {!! csrf_field() !!}
        ...
        <div class="col-lg-12">
            ...
            <form id='frmImportSubmit' style="solid #a1a1a1;margin-top: 15px;padding: 10px;" action="{{ URL::to('import/importElec/save') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                    {!! csrf_field() !!} 
            </form>
