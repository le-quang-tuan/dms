...
<div class="row">        
        ...
        <div class="col-md-12">
            <form style="border: 4px solid #a1a1a1;margin-top: 15px;padding: 10px;" action="{{ URL::to('import/importGas/store') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                {!! csrf_field() !!}
                ...
                <table class="table table-striped table-bordered table-hover table-condensed">
                    <tbody>
                        <tr>
                            ...
                            <td class="col-md-1">File import<em style='color:red'>(*)</em> </td>
                            <td class="col-md-1">
            ...
            <form style="border: 4px solid #a1a1a1;margin-top: 15px;padding: 10px;" action="{{ URL::to('import/importGas/save') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                {!! csrf_field() !!}
