...
<script>
    ...
    $(function () {
        ...
        $("#date_to").val(lastDay);
        $("#comment").val("Chỉ số gas sử dụng tháng " + preMonth + "/" + year);
    });
</script>
@endsection
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        ...
        <h2>Nhập chỉ số tiêu thụ Gas từ File</h2>
      </div>
    </div>
  </div>
</div>
...
<div class="table-responsive">
    ...
    <div class="col-lg-12">
        {{ Form::open(['route' => ['ImportGas.download'],  'method' => 'POST', 'id'=>'frmtenementFlatGas']) }}
            {!! csrf_field() !!}
            <h3>1) Tải file mẫu sau khi nhập các thông tin chung</h3>
            <table class="table table-striped table-bordered table-hover table-condensed">
                <tbody>
                    <tr class="info" style="color: black">
                        <td>Chỉ số gas cho Phiếu thu tháng<em style='color:red'>(*)</em> </td>
                        <td>
                        ...
                        <td>Ghi chú</td>
                        <td colspan="2">
                            <input type="text" name="comment" id="comment" name="comment" size="50%">
                                {!!old('comment') !!}
                            </input>
                        </td>
                        <td>
                            <button id='tenementFlatGasSubmit' type="button" class="btn btn-primary">File Excel Mẫu</button>
                        </td>
                    </tr>
                </tbody>
            </table>
    ...
    <div class="col-lg-12">
        <form style="margin-top: 15px;" action="{{ URL::to('import/importGas/store') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
    ...
    <div class="col-lg-12">
        ...
        <form id='frmImportSubmit' style="margin-top: 15px;" action="{{ URL::to('import/importGas/save') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}                
        </form>
    ...
    <div class="col-lg-12">
        <h3>Chỉ số gas được import từ các căn hộ</h3>
