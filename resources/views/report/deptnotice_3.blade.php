            ...
            <div>
                <div class="col-xs-11" style="text-align: center;">
                    <br>
                        ...
                        <i>THE 3rd REMINDER OF INVOICE OUTSTANDING </i>
                </div>
            </div>
        </div>
        ...
        <div class="row voffset1" id="container">
            ...
            <div class="col-xs-11">
                <div class="col-xs-12 text-left" style="font-size: 14px">
                    ...
                    Ban quản lý chung cư xin thông báo: trong vòng 03 ngày kể từ ngày thông báo này được phát hành gửi Quý cư dân mà vẫn chưa thanh toán phí dịch vụ chúng tôi buộc phải tạm giảm chất lượng dịch vụ cho căn hộ của Quý cư dân. Dịch vụ sẽ được cung cấp đúng chất lượng trở lại trong vòng 30 phút sau khi quý khách thanh toán đầy đủ số tiền nêu trên.
                    <br>
                    <i>The Building Management would like to inform that Residents have not paid service fees within 03 days since this announcement was issued, we have to cease supplying services to your Apartment. All expenses incurred as a result of late payment of fees will be paid by the Residents. The service will be returned within 30 minutes after you pay in full. </i>  <br><br>
