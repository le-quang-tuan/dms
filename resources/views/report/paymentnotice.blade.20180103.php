    ...
    @foreach($paymentnotic_lst as $paymentnotice)
        ...
        <div>
            <div>
                ...
                <div class="col-xs-11">
                    <i>We are pleased to inform about the fee in Dec, 2017</i>
                </div>
        ...
        <div class="row voffset1">
            ...
            <div class="col-xs-11">
                <div class="col-xs-12 text-left" style="font-size: 10px">
                    ...
                    Nội dung thanh toán ghi như sau: Thanh toán phí quản lý, tiền nước, giữ xe căn hộ A-0702 kỳ 12/2017.<br><br>
