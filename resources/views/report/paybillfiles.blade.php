        ...
        var table = $('#users-table').DataTable({
            ...
            columns: [
                ...
                { data: 2, title: "Căn Hộ" },
                {
                    data: null, 
                    render: function ( data, type, row ) {
                        return '<a href="../pv_paybillfiles/'+ tenement_id + '/' + year_month + '/' + data[3] + '">'+ data[3] + '</a>';
                    },
                    title: "Xem trước"
                },
                {
                    data: null, 
                    render: function ( data, type, row ) {
                        return '<a href="../dl_paybillfiles/'+ tenement_id + '/' + year_month + '/' + data[3] + '">'+ data[3] + '</a>';
                    },
                    title: "Tải file"
                },
            ]
...
<div class="table-responsive">
    <div class="col-lg-12">
        <form id='frmMerge' action="{!! route('File.exe_merge_paybill', $year_month) !!}" method="POST" role="form" method="post">
            {!! csrf_field() !!}
