...
<script>
    $(function () {
        ...
        var time = JSON.parse(<?php echo json_encode($time); ?>);
            ...
            columns: [
                ...
                { data: 1, title: "Căn Hộ" },
                {
                    ...
                    render: function ( data, type, row ) {
                        return '<a href="../dl_deptnoticefiles/' + data[2] + '">'+ data[1] + '</a>';
                    },
                    title: "Xem trước"
                },
                {
                    data: null, 
                    render: function ( data, type, row ) {
                        return '<a href="../pv_deptnoticefiles/' + data[2] + '">'+ data[1] + '</a>';
                    },
                    title: "Tải file"
                },
            ]
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        ...
        <h2>Danh Sách Thông Báo Nợ lần 1</h2>
      </div>
    </div>
  </div>
</div>
...
<div class="table-responsive">
    <div class="col-lg-12">
        <form id='frmMerge' action="{!! route('File.dept_notices_merge', $time) !!}" method="POST" role="form" method="post">
            {!! csrf_field() !!}
