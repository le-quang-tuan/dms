...
<div id="aaa">
    ...
    @foreach($paymentnotic_lst as $paymentnotice)
        ...
        <div>
            <div>
                <table class="table-bordered detail" style="margin-left: 50px;width: 95%">
                    <tbody>
                        <tr>
        ...
        <div>
            <table class="table-bordered detail" style="margin-left: 50px;width: 95%">
                <tbody>
                    <tr>
                        <th class="col-xs-2 text-center">Chỉ số cũ/<br>Previous figure</th>
                        <th class="col-xs-2 text-center">Chỉ số mới/<br>Current figure</th>
                        <th class="col-xs-2 text-center">Chỉ số tiêu thụ/<br>Electric use (Kwh)</th>
                        <th class="col-xs-2 text-center">Đơn giá/ Rate</th>
                        <th class="col-xs-2 text-center">Thành tiền/<br>Amount(VND)</th>
                    </tr>
                    <tr>
                        <td class="col-xs-2 text-center">{!! $water[0]->old_index_hd!!}15</td>
                        <td class="col-xs-2 text-center">{!! $water[0]->new_index_hd!!}24</td>
                        <td class="col-xs-2 text-center">{!! $water[0]->mount_hd !!}9</td>
        ...
        <div>
            <table class="table-bordered detail" style="margin-left: 50px;width: 95%">
                <tbody>
                    ...
                    <tr>
                        <td class="text-left" colspan="4">Phí BVMT(10%)</td>
                        <td class="text-right">15250</td>
                    </tr>
                    <tr>
                        <td class="text-left" colspan="4">Tổng cộng /Total (VND)</td>
        ...
        <div>
            <div>
                <table class="table-bordered detail" style="margin-left: 50px;widtd: 95%">
                    <tbody>
                        <tr>
                            <td class="col-xs-3 text-center">Chỉ số cũ/<br>Previous figure</td>
                            <td class="col-xs-2 text-center">{!! $gas[0]->old_index_hd!!}</td>
                            <td class="col-xs-2 text-center">Chỉ số mới/<br>Current figure</td>
                            <td class="col-xs-1 text-center">{!! $gas[0]->new_index_hd!!}</td>
                            <td class="col-xs-2 text-center">Chỉ số tiêu tdụ/<br>Electric use (Kwh)</td>
                            <td class="col-xs-2 text-center">{!! $gas[0]->mount_hd !!}</td>
                        </tr>
            ...
            <table class="table-bordered detail" style="margin-left: 50px;width: 95%">
                <tbody>
                    <tr>
                        <th class="col-xs-2 text-center">Chỉ số cũ/<br>Previous figure</th>
                        <th class="col-xs-2 text-center">Chỉ số mới/<br>Current figure</th>
                        <th class="col-xs-2 text-center">Chỉ số tiêu thụ/<br>Gas use (Kg)</th>
                        <th class="col-xs-2 text-center">Đơn giá/ Rate</th>
                        <th class="col-xs-2 text-center">Thành tiền/<br>Amount(VND)</th>
                    </tr>
                    <tr>
        ...
        <div>
            <div class="col-xs-11">
                <b>&nbsp;&nbsp;&nbsp;&nbsp;  7.Nợ cũ-Truy Thu/Previous debit:</b>
            </div>
        </div>
        <div>
            <div>
                <table class="table-bordered detail" style="margin-left: 50px;width: 95%">
                    <tbody>
                        <tr>
                            ...
                            Water fee</th>
                            <th class="col-xs-2 text-center">Phí Gas/<br>
                            Gas fee</th>
                            <th class="col-xs-1 text-center">Phí Giữ Xe/<br>
                            Parking fee</th>
        ...
        <div>
            <div class="col-xs-12 text-left" style="font-size: 10px">
                ...
                tính đến hết ngày 31/10/2016. <br>Nếu khách hàng thanh toán sau ngày này, chúng tôi sẽ cập nhật vào phiếu của kỳ sau.<br>
                ...
                updated until Oct 31, 2016. <br>So, in case the residents have paid after this time, the payment will be updated to the next
