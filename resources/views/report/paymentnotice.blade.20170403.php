    ...
    @foreach($paymentnotic_lst as $paymentnotice)
        ...
        <div>
            <div>
                <div class="col-xs-11">
                    <br>
                    Ban quản lý tòa nhà Saigonres Plaza xin trân trọng thông báo về các khoản phí tháng 04/2017.
                </div>
                <div class="col-xs-11">
                    <i>We are pleased to inform about the fee in April, 2017</i>
                </div>
        ...
        <div>
            <div class="col-xs-11">
                <b>&nbsp;&nbsp;&nbsp;&nbsp;  {!! $number !!}. Tiền nước/ Water charge:&nbsp;</b> ({!! $date_from . "-" . $date_to !!}) 
            </div>
        ...
        <div>
            <table class="detail" style="margin-left: 50px;width: 95%">
                <tbody>
                    <tr>
                        <th>Chỉ số cũ<br><br>Old figure</th>
                        <th>Chỉ số mới<br><br>New figure</th>
                    ...
                    <tr>
                        ...
                        <td class="text-right">{!! number_format($water_dt->total .  $water[0]->other_fee01_money_hd . $water[0]->vat_money_hd . $water[0]->other_fee02_money_hd) !!}</td>
                    </tr>
                    @endforeach
        ...
        <div class="row voffset1">
            <div class="col-xs-11">
                <div class="col-xs-12 "><br><b>Tổng cộng/ Grand Total ({!! $stringNumber !!}):&nbsp;</b>{!! number_format($total_money) !!} &nbsp;VND</div>
        ...
        <div class="row voffset1">
            <div class="col-xs-11">
                <div class="col-xs-12 text-left" style="font-size: 12px">
                    ...
                    - &nbsp;&nbsp;&nbsp;&nbsp;Số TK/Beneficiary account number:&nbsp;<b>6067 0406 0031342</b><br>
                    - &nbsp;&nbsp;&nbsp;&nbsp;Ngân hàng/Bank:&nbsp; <b>Ngân hàng VIB</b><br>
                    - &nbsp;&nbsp;&nbsp;&nbsp;Chi nhánh:<b>Bình Thạnh/Binh Thanh Branch</b><br>
                    - &nbsp;&nbsp;&nbsp;&nbsp;Tên chủ tài khoản/Beneficiary name:&nbsp;<b>Công ty Cổ phần Đầu tư Bất Động Sản Hùng Vương</b><br>
                </div>
            </div>
            ...
            <div class="col-xs-11">
                <div class="col-xs-12 text-left" style="font-size: 12px">
                    ...
                    Nội dung thanh toán ghi như sau: Thanh toán phí quản lý, tiền nước, giữ xe căn hộ A-0702 kỳ 04/2017.<br><br>
