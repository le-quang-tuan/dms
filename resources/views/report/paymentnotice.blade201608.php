...
<div class="row voffset1">
    <div class="col-xs-11">
        ...
        <div class="col-xs-6"><b>Điện thoại/ Phone Number :</b> {!! $flat_info->phone !!}</div>
    ...
    <div class="col-xs-12">
        <table class="table table-bordered">
            <tbody>
                ...
                <tr>
                    <th class="text-center">{!! $elec_dt->elec_type_name . '(' . $elec[0]->elec_tariff_name . ')' !!}</th>
...
<div class="col-xs-12">
    <table class="table table-bordered">
        <tbody>
            <tr>
                <th class="col-xs-3 text-center">Chỉ số cũ/<br>Previous figure</th>
                <th class="col-xs-2 text-center">{!! $water[0]->old_index_hd!!}</th>
                <th class="col-xs-2 text-center">Chỉ số mới/<br>Current figure</th>
                <th class="col-xs-1 text-center">{!! $water[0]->new_index_hd!!}</th>
                <th class="col-xs-2 text-center">Chỉ số tiêu thụ/<br>Volumn (m3)</th>
                <th class="col-xs-2 text-center">{!! $water[0]->mount_hd !!}</th>
            </tr>
            
            <tr>
                <th class="text-center">Định mức/ Limits</th>
                <th class="text-center">Số khối/ Volumn(m3)</th>
                <th class="text-center">Đơn giá/ Rate</th>
                <th class="text-center">VAT()</th>
                <th class="text-center">Phí BVMT/Env.fee()</th>
                <th class="text-center">Thành tiền/<br>Amount(VND)</th>
            </tr>

            @foreach($water as $water_dt)
            <tr>
                <th class="text-center">{!! $water_dt->water_type_name . '(' . $water[0]->water_tariff_name . ')' !!}</th>
                <th class="text-center">{!! $water_dt->mount !!}</th>
                <th class="text-center">{!! $water_dt->price !!}</th>
                <th class="text-center">{!! $water_dt->vat_money !!}</th>
                <th class="text-center">{!! $water_dt->other_fee01_money !!}</th>
                <th class="text-right">{!! $water_dt->total !!}</th>
            </tr>
            @endforeach

            <tr>
                <th class="text-left" colspan="5">Phí hao hụt /Loss compensation({!! $water[0]->other_fee01_hd !!})</th>
    ...
    <div class="col-xs-12">
        <table class="table table-bordered">
            <tbody>
                ...
                <tr>
                    <th class="text-center">{!! $gas_dt->gas_type_name . '(' . $gas[0]->gas_tariff_name . ')' !!}</th>
