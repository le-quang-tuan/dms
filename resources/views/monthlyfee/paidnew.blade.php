    ...
    <div class="col-lg-12">
        ...
        <form id='frmpaymonthFlat' action="{!! route('PaymonthFlat.save') !!}" method="POST" role="form" method="post">
            ...
            <table class="table table-striped table-bordered table-hover table-condensed">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="3"><input type="text" value="{!! old('comment', 'Thu Phí Tháng') !!}" id="comment" name="comment" size="30%"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" value="{!! old('book_bill', date('ym') . $tenement->tenement_code) !!}" id="book_bill" name="book_bill" size="30%">
                        </td>
                        <td>Số bill<em style='color:red'>(*)</em></td>
                        <td>
                            <input type="text" value="{!! old('bill_no', $flat_info->bill_no) !!}" id="bill_no" name="bill_no" size="30%">
                        </td>
                    </tr>
                    @endrole
                </tbody>
            ...
            <table class="table">
                ...
                <button id='paymonthFlatSubmit' type="button" class="btn btn-primary">Lưu Phiếu Thu</button>
            </table>
            @endrole
        </form>       
    </div>
