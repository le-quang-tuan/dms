...
<script>
    ...
    $(function () {
        ...
        /* The plugin will submit form and scroll to top*/
        $("#tenementFlatServiceDelete").manualSubmit('frmCom');
                
        $("#tenementFlatServiceRefresh").manualRefresh('frmtenementFlatService');
    });
...
<div class="row">        
        <div class="col-md-12">
        <p class="pagetitle">Tạo mới Dịch vụ khác cho Căn Hộ</p>
            <!-- begin .flash-message -->
                ...
                <table class="table table-striped table-bordered table-hover table-condensed">               
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="col-md-1">Dịch vụ khác<em style='color:red'>(*)</em></td>

                            <td class="col-md-2"><input type="text" value="{!! old('name') !!}" id="name" name="name" size="30%"></td>

                            <td class="col-md-1">Số lượng<em style='color:red'>(*)</em></td>

                            <td class="col-md-1"><input  type="text" value="{!! old('mount') !!}" id="mount" name="mount" size="5%">
                            </td>

                            <td class="col-md-1">Đơn vị<em style='color:red'>(*)</em></td>

                            <td class="col-md-1"><input  type="text" value="{!! old('unit') !!}" id="unit" name="unit" size="5%">
                            </td>

                            <td class="col-md-1">Số tiền<em style='color:red'>(*)</em></td>
        ...
        <div class="col-md-12 col-md-offset-2">
            ...
            <button id='tenementFlatServiceSubmit' type="button" class="btn btn-primary">Create</button>            
            <button id='tenementFlatServiceRefresh' type="button" class="btn btn-default">Refresh</button>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
