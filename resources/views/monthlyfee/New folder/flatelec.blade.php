...
<script>
    ...
    $(function () {
        ...
        /* The plugin will submit form and scroll to top*/
        $("#tenementFlatElecDelete").manualSubmit('frmCom');
                
        $("#tenementFlatElecRefresh").manualRefresh('frmtenementFlatElec');
    });
...
<div class="row">        
        ...
        <div class="col-md-12 col-md-offset-2">
            ...
            <button id='tenementFlatElecSubmit' type="button" class="btn btn-primary">Create</button>            
            <button id='tenementFlatElecRefresh' type="button" class="btn btn-default">Refresh</button>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
