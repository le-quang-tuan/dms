...
<script>
    ...
    $(function () {
        ...
        /* The plugin will submit form and scroll to top*/
        $("#tenementFlatWaterDelete").manualSubmit('frmCom');
                
        $("#tenementFlatWaterRefresh").manualRefresh('frmtenementFlatWater');
    });
...
<div class="row">        
        ...
        <div class="col-md-12 col-md-offset-2">
            ...
            <button id='tenementFlatWaterSubmit' type="button" class="btn btn-primary">Create</button>            
            <button id='tenementFlatWaterRefresh' type="button" class="btn btn-default">Refresh</button>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
