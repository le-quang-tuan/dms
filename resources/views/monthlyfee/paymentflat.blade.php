...
<script>
    ...
    $(function () {
        ...
        $('#users-table').DataTable({
            ...
            serverSide: false,
            deferLoading: 0,
            ajax: '{!! url("monthlyfee/paid/{$flat_id}/anyData") !!}',
            columns: [
            ...
            <table class="table table-striped table-bordered table-hover table-condensed">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="3"><input type="text" value="{!! old('comment') !!}" id="comment" name="comment" size="70%"></td>
                    </tr>
                    <tr>
                        <td>Ngày nhận<em style='color:red'>(*)</em></td>
                        <td><input type="text" value="{!! old('receive_date') !!}" id="receive_date" name="receive_date" size="20%" class="date-picker" value="{!! date('d/m/Y') !!}"></td>
                        <td>Người nhận<em style='color:red'>(*)</em></td>
                        <td>
                            <input type="text" value="{!! old('receiver') !!}" id="receiver" name="receiver" size="20%">
                        </td>
                        <td>Nhận từ<em style='color:red'>(*)</em></td>
                        <td>
                            <input type="text" value="{!! $flat_info->name !!}" id="receive_from" name="receive_from" size="20%">
                        </td>
                    </tr>
