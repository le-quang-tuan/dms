...
<script>
    $(function () {
        ...
        var table = $('#users-table').DataTable({
            ...
            ajax: '{!! url("flat/all/water/anyData/'+ year + month + '") !!}',
            columns: [
        ...
        $('#flatSubmit').click(function() {
            ...
            var month = $("#month").val();
            table.clear().draw();
            table.ajax.url('{!! url("flat/all/water/anyData/'+ year + month + '") !!}').load();
        });
        ...
        $("#changeSubmit").click(function(){
            ...
            var prev_price_year = $("#prev_price_year").val();
            var prev_price_month = $("#prev_price_month").val();
                ...
                if(result){
                    ...
                    $.ajax({
                        ...
                        data: { 
                            ...
                            "prev_price_month" : prev_price_month,
                            "flat_id" : flat_id,
                            "_token": "{{ csrf_token() }}",
                        },
...
<form id='frmChange' action="{!! route('Water.exex_change') !!}" method="POST" role="form" method="post">
    ...
    <div class="modal fade" id="DescModal" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="row dataTable">
                    <div class="col-md-3">
                        <label class="control-label">Số m3 khấu trừ</label>
                    </div>
                    <div class="col-md-4">
                        <input type="text" class="form-control" id="deduct" name="deduct">
                    </div>
                </div>

                <div class="row dataTable">
                    <div class="col-md-3">
                        <label class="control-label">Hoặc Tính theo số tiền tháng</label>
                    </div>
                    <div class="col-md-4">
                        <select class="form-control" name="prev_price_year" id="prev_price_year">
                            <?php
                    ...
                    <div class="col-md-4">
                            <select class="form-control" name="prev_price_month" id="prev_price_month">
                            <?php 
                                echo "<option selected></option>";
                                for($i = 1 ; $i <= 12; $i++){
                                    echo "<option>" . str_pad($i,2,'0', STR_PAD_LEFT) . "</option>";
