...
<script>
    $(function () {
        ...
        var table = $('#users-table').DataTable({
            ...
            ajax: '{!! url("flat/all/gas/anyData/'+ year + month + '") !!}',
            columns: [
                {
                    data: null, 
        ...
        $('#users-table').on('click', 'button', function () {
            ...
            $("#comment").val("Chỉ số Gas sử dụng tháng " + month + "/" + year);
        ...
        $('#flatSubmit').click(function() {
            ...
            var month = $("#month").val();
            table.clear().draw();
            table.ajax.url('{!! url("flat/all/gas/anyData/'+ year + month + '") !!}').load();
        });
...
<form id='frmChange' action="{!! route('Gas.exex_change') !!}" method="POST" role="form" method="post">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">X</button>
                     <h3 class="modal-title">Cập nhật chỉ số Gas sử dụng</h3>
