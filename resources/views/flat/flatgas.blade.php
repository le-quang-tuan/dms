            ...
            $('#users-table').on('click', '.btn-details', function(){
               //showModalDialog("../../flat");
                var tableHeader = "<thead><tr>" +
                                  ...
                                  "<th>Header 3</th>" +
                                  "</tr></thead>";
                var urlGet = "flat/gas/"+ $(this).val() +"/destroy";
                ...
                bootbox.confirm(confirmTable, function (result) {
                    ...
                    if (result == true){
                        ...
                        success:function(data){
                            table.ajax.url('{!! url("flat/gas/{$TfGasUsed}/datatable") !!}').load();      
                        }});
                    }
                });
            });
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        ...
        <h2>Nhập Thông Tin tiêu thụ Gas của Căn hộ</h2>
      </div>
    </div>
  </div>
</div>
...
<div class="table-responsive">
    <div class="flash-message">
            ...
            <table class="table table-striped table-bordered table-hover table-condensed">               
                ...
                <tbody>
                    <tr>
                        ...
                        <td><input  type="text" value="{!! old('old_index') !!}" id="old_index" name="old_index" size="5%">~<input type="text" value="{!! old('new_index') !!}" id="new_index" name="new_index" size="5%"></td>
                        <td>Ghi chú</td>
                        <td >
        ...
        @role('admin|manager|moderator')
            <div>
                <br>
                <button id='tenementFlatGasSubmit' type="button" class="btn btn-primary">Thêm mới</button>            
                <a href="{!! route('TenementFlat') !!} " class="btn btn-info">Trở về màn hình trước</a>
            </div>
        @endrole
    </div>
    <div class="col-lg-12">
        <h3>Thông tin chỉ số Gas đã sử dụng</h3>
