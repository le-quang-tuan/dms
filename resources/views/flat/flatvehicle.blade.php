...
<script>
    ...
    $(function () {
        ...
        @role('admin|manager|moderator')
            ...
            $("#tenementFlatParkingSubmit").click(function(){
                bootbox.confirm("Chỉ số sử dụng sẽ được thêm mới?", function(result) {
                    if(result){
                        $("#frmtenementFlatParking").submit();
                    }
                });
            });

            $('#users-table').on('click', '.btn-details', function(){
                var urlGet = "flat/vehicle/"+ $(this).val() +"/destroy";
                ...
                bootbox.confirm(confirmTable, function (result) {
                    ...
                    if (result == true){
                        ...
                        success:function(data){
                            table.ajax.url('{!! url("flat/vehicle/{$TfVehicle}/datatable") !!}').load();      
                        }});
                    }
                });
            });
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        ...
        <h2>Nhập Thông Tin xe đăng ký gửi</h2>
      </div>
    </div>
  </div>
</div>
...
<div class="table-responsive">
    <div class="flash-message">
        ...
        @role('admin|manager|moderator')
            <div>
                <br>
                <button id='tenementFlatParkingSubmit' type="button" class="btn btn-primary">Thêm mới</button>            
