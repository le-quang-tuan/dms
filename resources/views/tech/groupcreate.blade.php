...
<script>
    ...
    $(function(){
        ...
        $("#tenementGroupSubmit").manualSubmit('frmTenementGroup');
    });
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        ...
        <h2>Tạo mới Nhóm Máy Móc - Thiết Bị - Vật Tư</h2>
      </div>
    </div>
  </div>
</div>
...
<div class="table-responsive">
    <div class="flash-message">
        ...
        <form id='frmTenementGroup' action="{!! route('Group.store') !!}" method="POST" role="form" method="post">
            {!! csrf_field() !!}
        ...
        <div>
            ...
            <button id='tenementGroupSubmit' type="button" class="btn btn-primary">Thêm mới</button>    
