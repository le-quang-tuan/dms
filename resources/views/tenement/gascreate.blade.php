    ...
    $(function(){
        ...
        $(button_my_button).click(function(){
            ...
            var data="<tr class='new'><td class='text-center'><input type='checkbox' class='case'/></td>";
                ...
                data+="<td><input name='price"+count+"' id='price_"+count+"' class='form-control service'></td>";
                ...
                data+="<td><input name='other_fee02"+count+"' id='other_fee02_"+count+"' class='form-control service'></td>";
...
<div class="table-responsive">
    ...
    <form id='frmTenementGas' action="{!! route('TenementGas.store') !!}" method="POST" role="form" method="post">
        {!! csrf_field() !!}
        <table class="table table-striped table-bordered table-hover table-condensed">
            <tbody>
                <tr>
                    <td>Biểu phí gas sử dụng<em style='color:red'>(*)</em> </td>
    ...
    <div >
        <br>    
        <button id='tenementGasSubmit' type="button" class="btn btn-primary">Lưu mới</button> &nbsp;
