        ...
        if(Input::hasFile('import_file')){
            ...
            if(!empty($data) && $data->count()){
                ...
                foreach ($data as $key => $value) {
                    ...
                    // if ($value->giu_xe_tu_ngay != "")
                    //     $date_from = date("Ymd", strtotime(str_replace('/', '-',$value->giu_xe_tu_ngay)));
                    
                    // if ($value->giu_xe_den_ngay != "")
                    //     $date_to = date("Ymd", strtotime(str_replace('/', '-',$value->giu_xe_den_ngay)));
                    ...
                    $insert[] = [
                        ...
                        'name' => $value->chu_xe,
                        'number_plate' => $value->bien_so,
                        'label' => $value->hieu_xe,
                        'maker' => $value->hang_xe,
                        'color' => $value->mau_xe,
                        'vehicle_type_code' => $value->loai_phi_xe,
